...
def register_datasets_mixtures():
    ...
    filter_sharegpt4v_sft = Dataset(
        dataset_name="filter_sharegpt4v_sft",
        dataset_type="torch",
    ...
    add_dataset(filter_sharegpt4v_sft)
    ...
    filter_sharegpt4v_pretrain = Dataset(
        dataset_name="filter_sharegpt4v_pretrain",
        dataset_type="torch",
    ...
    add_dataset(filter_sharegpt4v_pretrain)
