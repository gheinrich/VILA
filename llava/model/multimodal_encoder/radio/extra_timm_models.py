...
from timm.models.vision_transformer import Mlp, VisionTransformer, _create_vision_transformer
...
def vit_huge_patch16_224(pretrained=False, **kwargs) -> VisionTransformer:
    ...
    if pretrained:
        ...
        model = _create_vision_transformer(
            "vit_huge_patch14_clip_336", pretrained=True, **dict(model_args, pre_norm=True, **kwargs)
        )
    else:
