    ...
    for mod in model.modules():
        if isinstance(mod, Attention):
            ...
            parametrize.register_parametrization(
                ...
                "weight",
                _SNReweight(
                    mod.fc1.weight, n_power_iterations, dim=0, eps=eps, init_norm_to_current=init_norm_to_current
                ),
            )
            parametrize.register_parametrization(
                mod.fc2,
                "weight",
                _SNReweight(
                    mod.fc2.weight, n_power_iterations, dim=0, eps=eps, init_norm_to_current=init_norm_to_current
                ),
            )
            pass
