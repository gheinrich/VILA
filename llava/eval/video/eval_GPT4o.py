...
def parse_args():
    ...
    parser.add_argument("--pred_path", type=str, default="/lustre/fs2/portfolios/nvr/users/yukangc/VILA-Internal-main-3/eval_output/Gemini/pred2.json",  help="The path to file containing prediction.")
    parser.add_argument("--save_dir", type=str, default="Gemini_golden", help="The path to save annotation json files.")
    parser.add_argument("--video_dir", type=str, default="/lustre/fs2/portfolios/nvr/users/yukangc/download_videos/short_videos_eval", help="The path to save annotation final combined json file.")
...
def gpt_api_no_stream(question, pred, video_path, eval_type="correctness"):
    ...
    for _ in range(API_MAX_RETRY):
        try:
            response = client.chat.completions.create(model=deployment_name, messages=messages, max_tokens=2000, temperature=0)
