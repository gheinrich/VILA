        ...
        try:
            ...
            for fmt in video_formats:  # Added this line
                ...
                if os.path.exists(temp_path):
                    ...
                    output_1 = get_model_output(model, image_processor, tokenizer, video_path, question_1, args)
                    sample_set['pred1'] = output_1

                    # Run inference on the video for the second question and add the output to the list
                    output_2 = get_model_output(model, image_processor, tokenizer, video_path, question_2, args)
