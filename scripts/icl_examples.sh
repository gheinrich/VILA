# python llava/eval/run_llava.py --model-path checkpoints/vicuna-13b-finetune-llava+lrv-downsampleproj-e1-nose --conv-mode vicuna_v1_1 \
...
# logo example
python llava/eval/run_llava.py --model-path checkpoints/vicuna-13b-finetune-llava+lrv+sharegpt-downsampleprojse-e1-nose --conv-mode vicuna_v1_1 \
...
python llava/eval/run_llava.py --model-path checkpoints/flanvicuna-7b-vflan-finetune-llava+lrv-downsampleprojse-e1-nose --conv-mode vicuna_v1_1 \
...
# reasoning examples
python llava/eval/run_llava.py --model-path checkpoints/vicuna-13b-vflan-finetune-llava+lrv-downsampleprojse-e1-nose-tuneffn --conv-mode vicuna_v1_1 \
...
python llava/eval/run_llava.py --model-path checkpoints/llama2-7b-mmc4sub+coyoaccum-finetune-dualflan-linearclip-e1-nose --conv-mode vicuna_v1_1 \
...
# new llama2 model
python llava/eval/run_llava.py --model-path checkpoints/llama2-13b-mmc4sub+coyo-finetune-cleandualflan+llava+sgpt-linearclip-e1-nose-run2 --conv-mode vicuna_v1_1_nosys \
...
python llava/eval/run_llava.py --model-path checkpoints/llama2-13b-mmc4sub+coyo-finetune-cleandualflan+llava+sgpt-linearclip-e1-nose-run2 --conv-mode vicuna_v1_1 \
...
python llava/eval/run_llava.py --model-path checkpoints/llama2-13b-clip336-mmc4sub+coyo-finetune-cleandualflan+llava+sgpt-linearclip-e1-nose-run2 --conv-mode vicuna_v1_1 \
...
python llava/eval/run_llava.py --model-path ~/models/llava/llava-v1.5-13b-patched/ --conv-mode vicuna_v1_1 \
    --query "<image>\n###Les sanglots longs des violons de l’automne blessent mon coeur d’une langueur monotone.###<image>\n###Pour qui sont ces serpents qui sifflent sur vos têtes?###<image>\n" \
    --image-file "images/icl-french/violin.png###images/icl-french/snake.png###images/icl-french/swarm.png"
