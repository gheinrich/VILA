...
python llava/eval/run_vila.py --model-path checkpoints/llama2-7b-mmc4sub-dualflan-finetune-llava+sharegpt-linearclip-e1-nose --conv-mode vicuna_v1_1 \
...
python llava/eval/run_vila.py --model-path checkpoints/llama2-7b-mmc4sub-finetune-dualflan-linearclip-e1-nose --conv-mode vicuna_v1_1 \
