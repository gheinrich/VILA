...
DEFAULT_RUN_NAME="stage15_J67_9tile"
DEFAULT_GLOBAL_TRAIN_BATCH_SIZE=1024
DEFAULT_GRADIENT_ACCUMULATION_STEPS=2
STAGE1_PATH="runs/train/stage1_J67_9tile/model"
...
torchrun \
    ...
    llava/train/train_mem.py \
        ...
        --data_mixture docmatix_2+docmatix_3+pdfa-1m+allava_caption_vflan+unichart-pretrain+coyo_25m_wds_spatial_ocr_bbox_interleaved_qas_30+mtwi+art1+art2+lsvt \
