...
#SBATCH --partition=interactive,grizzly,polar,grizzly2,polar2,polar3
#SBATCH --dependency=singleton
#SBATCH --output=eval-msvd-score.out

CKPT_NAME=vicuna-7b-siglipso400m-ccs-coyo_25m_mmc4core_sharegpt4v_internvid_1300K-finetune-vflan_sharegpt4v_sft_video_chatgpt_nv_video_flan-e11111
