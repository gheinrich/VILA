...
torchrun --nnodes=$n_node --nproc_per_node=8 --master_port=25001 \
    ...
    --bf16 True \
    --output_dir /lustre/fs2/portfolios/nvr/projects/nvr_aialgo_robogptagent/loragen_workspace/ckpts/vicuna-7b-siglipso400m-mmc4sub+coyo-finetune-vflan_sharegpt4v_sft-linear-e1010-test \
    --num_train_epochs 1 \
