...
torchrun --nnodes=$n_node --nproc_per_node=8 --master_port=25001 \
    ...
    --pretrain_mm_mlp_adapter checkpoints/mistral-7b-ccs-test/mm_projector.bin \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --bf16 True \
    --output_dir ./checkpoints/mixtral-7b-clip336-finetune-mmc4sub+coyo+sharegpt4v-linear-e1 \
    --num_train_epochs 1 \
