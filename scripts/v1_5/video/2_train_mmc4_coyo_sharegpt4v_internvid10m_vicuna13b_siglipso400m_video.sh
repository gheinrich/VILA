...
torchrun --nnodes=$n_node --nproc_per_node=8 --master_port=25001 \
    ...
    --model_name_or_path ./checkpoints/vicuna-13b-siglipso400m-pretrain-ccs-video-linear-e11112 \
    --version v1 \
    ...
    --bf16 True \
    --output_dir ./checkpoints/vicuna-13b-siglipso400m-pretrain-ccsvideo-coyo_25m_mmc4core_sharegpt4v_internvid_10M-linear-e11113 \
    --num_train_epochs 1 \
