...
torchrun --nnodes=$n_node --nproc_per_node=8 --master_port=25001 \
    ...
    --version v1 \
    --data_mixture coyo_25m+mmc4core+sharegpt4v_pretrain+internvid_10M+ego4d_1M \
    ...
    --bf16 True \
    --output_dir ./checkpoints/vicuna-7b-siglipso400m-pretrain-ccsvideo-coyo_25m_mmc4core_sharegpt4v_internvid_10M_ego4d_1M-linear-e2 \
    --num_train_epochs 1 \
