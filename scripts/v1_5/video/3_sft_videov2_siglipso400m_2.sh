...
torchrun --nnodes=$n_node --nproc_per_node=8 --master_port=25001 \
    ...
    --bf16 True \
    --output_dir /lustre/fsw/portfolios/nvr/projects/nvr_aialgo_robogptagent/loragen_workspace/ckpts/vicuna-7b-siglipso400m-ccs-coyo_25m_mmc4core_sharegpt4v_internvid_1300K-finetune-baseline_nv_video_flan_jukin_shot2story_shot_only-e11111 \
    --num_train_epochs 1 \
