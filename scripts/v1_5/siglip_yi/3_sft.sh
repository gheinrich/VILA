...
torchrun --nnodes=$n_node --nproc_per_node=8 --master_port=25001 \
    ...
    --model_name_or_path /home/jasonlu/workspace/multi-modality-research/VILA/checkpoints/vila-yi-34b-siglip-alignment_fix850_cs \
    --version hermes-2 \
    ...
    --bf16 True \
    --output_dir ./checkpoints/vila-yi-34b-siglip-alignment_fix851_cs \
    --num_train_epochs 1 \
