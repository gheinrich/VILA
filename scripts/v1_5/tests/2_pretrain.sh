...
OUTPUT_STEP1=${1:-"checkpoints/$MNAME-$VISION_TOWER-align-$ALIGN_DATASET"}
OUTPUT_STEP2=${2:-"checkpoints/$MNAME-$VISION_TOWER-align-$ALIGN_DATASET-pretrain-$PT_DATASET"}
