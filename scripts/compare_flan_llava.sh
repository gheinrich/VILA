python llava/eval/run_llava.py --model-name checkpoints/vicuna-7b-finetune-vflan+tflan-downsampleprojse-e1-nose --conv-mode vicuna_v1_1 \
...
python llava/eval/run_llava.py --model-name checkpoints/vicuna-7b-dualflan-finetune-llava+lrv+sharegpt-downsampleprojse-e1-nose --conv-mode vicuna_v1_1 \
    --query "How many legs do the animals in the picture have in total? Think step by step."     --image-file "images/puppy_and_kitten.webp"
...
python llava/eval/run_llava.py --model-name checkpoints/vicuna-7b-dualflan-finetune-llava+sharegpt-downsampleprojse-e1-nose --conv-mode vicuna_v1_1 \
    --query "Write a poem for the scene."     --image-file "images/puppy_and_kitten.webp"
