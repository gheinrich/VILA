#!/bin/bash
#SBATCH --job-name=vila-7b-ego4d-pretraining:nvr_lpr_aiagent
#SBATCH --nodes=32
#SBATCH --gres=gpu:8
#SBATCH --time=4:00:00
...
#SBATCH --output=7b-internvid-1m-training.out
...
# srun --label bash ~/workspace/VILA-Internal/scripts/v1_5/video/2_train_mmc4_coyo_sharegpt4v_ego4d1m_vicuna_siglipso400m.sh
