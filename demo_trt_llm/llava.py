...
class AltLlamaDecoderLayer(nn.Module):
...
class LlavaLlamaModel(LlamaModel):
    ...
    def forward(
        ...
        if (
            ...
            with nullcontext() if getattr(
                ...
                if "visiontransformer" in vision_tower.__class__.__name__.lower():
                    ...
                    select_hidden_state_layer = getattr(
                        self.config, "vision_select_layer", -1
                    )
            ...
            dummy_image_features = self.vision_projector(dummy_image_features)[
                0
            ]  # (1, N, D)
        ...
        ret = super(LlavaLlamaModel, self).forward(
            input_ids=None,
            attention_mask=attention_mask,
