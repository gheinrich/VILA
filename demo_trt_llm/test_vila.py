...
from transformers import (AutoConfig, AutoProcessor, AutoTokenizer,
                          ...
                          NougatProcessor, NougatTokenizerFast, CLIPVisionModel)
...
def image_processing(images, args):
    ...
    vision_tower = CLIPVisionModel.from_pretrained(config["mm_vision_tower"]).to(device="cuda", dtype=torch.float16)
    with torch.no_grad():
